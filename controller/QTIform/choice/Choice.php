...
/**
 * Short description of class oat\taoQtiItem\controller\QTIform\choice\Choice
 *
 * @abstract
 * @access public
 ...
 */
abstract class Choice extends tao_helpers_form_FormContainer
{
     ...
     * @param  Data choice
     */
    public function __construct(Element $choice = null){
        $this->choice = $choice;
