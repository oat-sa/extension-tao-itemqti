...
use oat\taoQtiItem\controller\QTIform\interaction\SliderInteraction;
    ...
    extends BlockInteraction
{
    ...
    public function initElements()
    {
		...
		$this->form->addElement(AssessmentItem::createTextboxElement($interaction, 'lowerBound', __('Lower bound')));//mendatory 0
        $this->form->addElement(AssessmentItem::createTextboxElement($interaction, 'upperBound', __('Upper bound')));//mendatory 10
        $this->form->addElement(AssessmentItem::createTextboxElement($interaction, 'step', __('Step')));
		
		//the very optional step label attr is temporaily disabled in authoring since the runtime does not support it properly
        //$this->form->addElement(oat\taoQtiItem\controller\QTIform\AssessmentItem::createBooleanElement($interaction, 'stepLabel', __('Step label display')));//false
		...
		$this->form->addElement(AssessmentItem::createBooleanElement($interaction, 'reverse', __('Reverse rendering')));//false		
    }
