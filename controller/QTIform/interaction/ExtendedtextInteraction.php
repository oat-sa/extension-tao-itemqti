...
use oat\taoQtiItem\controller\QTIform\interaction\ExtendedtextInteraction;
    ...
    extends StringInteraction
{
    ...
    public function initElements()
    {
		...
		$promptBody = QtiAuthoringService::singleton()->getFilteredData($this->interaction->getPromptObject());
		if(!empty($promptBody)){
