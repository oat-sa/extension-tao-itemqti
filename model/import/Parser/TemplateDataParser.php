...
class TemplateDataParser extends ConfigurableService
{
    public function parser(array $finalHeader): array
    {
        
        $sampleValues = $this->getDefaultValues($finalHeader);
        return $sampleValues;
    }

    private function getDefaultValues($finalHeader): array
    {
