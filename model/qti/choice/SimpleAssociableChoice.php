...
use oat\taoQtiItem\model\qti\choice\SimpleAssociableChoice;
 ...
 */
class SimpleAssociableChoice extends ContainerChoice
{
    /**
     ...
     * @var string
     */
    protected static $qtiTagName = 'simpleAssociableChoice';
