...
namespace oat\taoQtiItem\model\qti\metadata\extractors;

use oat\taoQtiItem\model\qti\metadata\LomMetadata;
use oat\taoQtiItem\model\qti\metadata\MetadataExtractor;

/**
 * Class LomMetadataExtractor
 *
 * @package oat\taoQtiItem\model\qti\metadata\extractors
 *
 * @deprecated Use TAO LOM extension instead!
 */
