...
use oat\taoQtiItem\model\qti\attribute\Shape;
...
class Shape extends Attribute
{
	...
	static protected $name = 'shape';
	static protected $type = 'oat\\taoQtiItem\\model\\qti\\datatype\\Shape';
	static protected $defaultValue = null;
	static protected $required = true;

} /* end of class oat\taoQtiItem\model\qti\attribute\Shape */