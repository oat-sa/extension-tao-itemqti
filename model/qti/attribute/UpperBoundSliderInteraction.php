...
use oat\taoQtiItem\model\qti\attribute\UpperBoundSliderInteraction;
use oat\taoQtiItem\model\qti\attribute\Attribute;

/**
 * The UpperBoundSliderInteraction attribute
 *
 * @access public
...
class UpperBoundSliderInteraction extends Attribute
{
	...
	static protected $name = 'upperBound';
    ...
    static protected $taoDefaultValue = 100;
