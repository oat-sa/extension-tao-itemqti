...
abstract class Composite extends ResponseProcessing implements Rule
{
    ...
    public static function takeOverFrom(ResponseProcessing $responseProcessing, Item $item)
    {
        ...
        common_Logger::i('Converted to Composite', ['TAOITEMS', 'QTI']);
    ...
    public function replace(InteractionResponseProcessing $newInteractionResponseProcessing)
    {
        ...
        if (!is_null($oldkey)) {
            ...
            common_Logger::w('Component to be replaced not found', ['TAOITEMS', 'QTI']);
        }
     ...
     * @return string
     */
    abstract public function getCompositionQTI();
     ...
     * @return array
     */
    abstract public function getCompositionRules();
}
