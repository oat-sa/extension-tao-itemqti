...
?>
<!--pretty print-->
<script src="<?=BASE_WWW?>js/qtiXmlRenderer/test/renderer/prism/prism.js" data-manual></script>
<script src="<?=BASE_WWW?>js/qtiXmlRenderer/test/renderer/vkBeautify.js"></script>
<link rel="stylesheet" href="<?=BASE_WWW?>js/qtiXmlRenderer/test/renderer/prism/prism.css">
