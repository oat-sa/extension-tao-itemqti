 ...
 *   });
    ...
    */
    ...
    var StackrelCommand = /** @class */ (function (_super) {
        ...
        function StackrelCommand() {
            var _this = _super.call(this) || this;
            _this.ctrlSeq = '\\stackrel';
            _this.htmlTemplate = '<span class="mq-stackrel mq-non-leaf">' +
                '<span class="mq-top">&0</span>' +
                '<span class="mq-bottom">&1</span>' +
                '</span>';
            _this.textTemplate = ['stackrel(', ',', ')'];
            return _this;
        }
        StackrelCommand.prototype.numBlocks = function () {
            return 2;
        };
        StackrelCommand.prototype.parser = function () {
            var self = this;
        ...
        StackrelCommand.prototype.createBlocks = function () {
    ...
    LatexCmds.stackrel = function () { return new StackrelCommand(); };
