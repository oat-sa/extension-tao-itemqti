define([
  ...
  var createWidget = function() {
    ...
    var createFeedback = function(){
      return $('<div>', { class: 'feedback lft', html: '<span class="icon-info"/>' + __('Final rendering may differ from this preview!') });
    };
    ...
    var createToggler = function(type){
      ...
      // view togglers
      if(type === 'mobile') {
        toggleText = __('Desktop preview');
        toggleTarget = 'desktop';
        icon = 'icon-screen';
      }
      else {
        toggleText = __('Mobile preview');
        toggleTarget = 'mobile';
        icon = 'icon-tablet';
      }

      toggler = $('<span>', { class: 'btn-info toggle-view small', html: '<span class="' + icon + '"/>' + toggleText }).prop('target', toggleTarget);
    ...
    var createCloser = function() {
      var closer = $('<span>', { class: 'btn-info small', html: 'Close <span class="icon-close r"/>' });
