...
define([
...
], function(_, __, stateFactory, Correct, SelectPointInteraction, helper, PciResponse){
    ...
    function initCorrectState(){
        ...
        helper.appendInstruction(interaction, __('Please select the correct selectPoint choices below.'));
        
        //use the common Renderer
        SelectPointInteraction.render.call(interaction.getRenderer(), interaction);
    ...
    /**
     * The correct answer state for the selectPoint interaction
     * @extends taoQtiItem/qtiCreator/widgets/states/Correct
     * @exports taoQtiItem/qtiCreator/widgets/interactions/selectPointInteraction/states/Correct
     */
