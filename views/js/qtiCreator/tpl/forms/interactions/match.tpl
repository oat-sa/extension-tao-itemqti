...
<div class="feedback-info match-display-mode-info match-non-tabular-info" style="display:none;">
...
<div class="panel position-panel" style="display:none;">
    <fieldset>
        <legend>{{__ 'Choices position'}}</legend>
...
<div class="panel">
    ...
    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content:first" data-tooltip-theme="info"></span>
    <span class="tooltip-content">
{{__ "If the shuffle attribute is true then the delivery engine will randomize the order in which the choices are initially presented. However each choice may be \"shuffled\" or \"fixed\" individually."}}
    </span>
</div>
{{/if}}
