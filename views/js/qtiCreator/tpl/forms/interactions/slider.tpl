...
<div class="panel">
    ...
    <input name="lowerBound" value="{{lowerBound}}" data-increment="1" data-min="0" data-validate="$integer" type="text" />
    ...
    <input name="upperBound" value="{{upperBound}}" data-increment="1" data-min="0" data-validate="$integer" type="text" />
    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content:first" data-tooltip-theme="info"></span>
...
<div class="panel">
    ...
    <input name="step" value="{{step}}" data-increment="1" data-min="0" data-validate="$integer" data-max="{{upperBound}}" type="text" />
    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content:first" data-tooltip-theme="info"></span>
