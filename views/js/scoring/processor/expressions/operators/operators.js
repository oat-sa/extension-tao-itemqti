...
], function( and, anyN, containerSize, deletee, divide, equal, gcd, gt, gte, integerDivide, integerModulus, integerToFloat, isNull, lcm, lt, lte, match, max, min, not, or, ordered, power, product, round, repeat, roundTo, stringMatch, substring, subtract, sum, truncate ){
    'use strict';
