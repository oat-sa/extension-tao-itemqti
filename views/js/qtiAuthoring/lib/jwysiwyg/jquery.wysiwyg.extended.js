...
function getCustomControl(action, params){
    ...
    var addCSS = function(href){
        require(['taoQtiItem/qtiAuthoring/lib/murmurhash/murmurhash3_gc'], function(){
    ...
    var dependencies = {
        ...
        customHTML : {
            ...
            css : [root_url + 'taoQtiItem/views/js/qtiAuthoring/lib/codemirror/codemirror.css',
                root_url + 'taoQtiItem/views/js/qtiAuthoring/lib/codemirror/codemirror-taoQtiItem.css']
        }
    };
