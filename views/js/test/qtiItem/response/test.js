...
define([
    ...
    'json!taoQtiItem/test/qtiItem/response/data/extended-text.json',
    'json!taoQtiItem/test/qtiItem/response/data/extended-text-manual-scoring.json',
    ...
    var cases = [
        ...
        { title : 'single choice correct - impossible min choice', data : dataChoiceCorrectMultiple, expectedMaximum: 0, maxScore: 0, changeData : function(data){
        ...
        { title : 'extended text', data : dataExtendedText, expectedMaximum: undefined, maxScore: undefined},
        { title : 'extended text - manual scoring', data : dataExtendedTextManualScoring, expectedMaximum: undefined, maxScore: 3},
