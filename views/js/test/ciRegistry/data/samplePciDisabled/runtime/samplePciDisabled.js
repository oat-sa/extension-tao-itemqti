define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'samplePciDisabled/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){

    var samplePciDisabled = {
        id : -1,
        getTypeIdentifier : function(){
            return 'samplePciDisabled';
        },
        /**
         * Render the PCI :
         * @param {String} id
...
//            var assetManager = qtiCustomInteractionContext.getAssetResolver(this.getTypeIdentifier());//that would introduce dependency between the asset manager and global pci runtime context
    ...
    qtiCustomInteractionContext.register(samplePciDisabled);
});