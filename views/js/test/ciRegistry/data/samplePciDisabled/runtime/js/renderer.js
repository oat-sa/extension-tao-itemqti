define(['IMSGlobal/jquery_2_1_1', 'OAT/util/html'], function($, html){
    ...
    function renderLabels(id, $container, config, assetManager){
        ...
        $labelMin.append($('<img>', {src: assetManager.resolve('samplePciDisabled/runtime/assets/ThumbDown.png')}).css({top: 6, marginLeft:12}));
        $labelMax.prepend($('<img>', {src: assetManager.resolve('samplePciDisabled/runtime/assets/ThumbUp.png')}).css({top: 2, marginRight:12}));
