    ...
    QUnit.asyncTest('Display and play', function(assert){
        ...
        qtiItemRunner('qti', gapMatchData)
            .on('render', function(){
                ...
                assert.equal($container.find('.qti-interaction.qti-graphicGapMatchInteraction').length, 1, 'the container contains a choice interaction .qti-gapMatchInteraction');
                // assert.equal($container.find('.qti-gapMatchInteraction .qti-choice').length, 16, 'the interaction has 16 choices including gaps');
