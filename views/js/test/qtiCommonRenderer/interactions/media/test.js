    ...
    QUnit.asyncTest('renders correctly', function(assert){
        ...
        qtiItemRunner('qti', mediaData)
            .on('render', function(){
                ...
                assert.equal($container.find('.qti-mediaInteraction video').attr('src'),'./big-buck-bunny-480p-h264-aac-25fps-1800k-short.mp4', 'the interaction has proper file attached');
