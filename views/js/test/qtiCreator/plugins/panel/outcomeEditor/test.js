...
define([
    'jquery',
    'lodash',
    'taoQtiItem/qtiCreator/panel/outcomeEditor'
], function ($, _, outcomeEditor) {
    'use strict';

    var outcomeEditorFactory = outcomeEditor();

    QUnit.module('API');

    QUnit.test('module', assert => {
        // const fixture = document.getElementById('fixture-api');
        const instance1 = outcomeEditorFactory();
        const instance2 = outcomeEditorFactory();
        assert.expect(3);
        assert.equal(typeof outcomeEditorFactory, 'function', 'The module exposes a function');
