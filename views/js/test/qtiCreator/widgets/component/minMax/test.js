...
define([
    ...
    QUnit.asyncTest('fields', function(assert) {
    ...
    QUnit.asyncTest('enable min using toggler', function(assert) {
        var container = document.getElementById('qunit-fixture');
    ...
    QUnit.asyncTest('enable/disable max using method', function(assert) {
        var container = document.getElementById('qunit-fixture');
    ...
    QUnit.asyncTest('change values, upper bound', function(assert) {
        var container = document.getElementById('qunit-fixture');
    ...
    QUnit.asyncTest('change values, lower bound', function(assert) {
        var container = document.getElementById('qunit-fixture');
    ...
    QUnit.asyncTest('change thresholds ', function(assert) {
        var container = document.getElementById('qunit-fixture');
    ...
    QUnit.asyncTest('sync values', function(assert) {
        var container = document.getElementById('qunit-fixture');
