...
"taoQtiItem/qtiCommonRenderer/helpers/container"],function(Promise,waitForMedia,tpl,containerHelper){"use strict";return{qtiClass:"img",template:tpl,getContainer:containerHelper.get,render:function(img,data){return new Promise(function(resolve,reject){containerHelper.get(img).waitForMedia(resolve)})}}}),define("tpl!taoQtiItem/qtiCommonRenderer/tpl/include",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="";return buffer+='<div class="qti-include" data-href="'+(0,this.escapeExpression)(
"function"==typeof(stack1=null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.href)?stack1.apply(depth0):stack1)+'">\n    ',((stack1=(helper=helpers.body)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.body)?helper.call(depth0,{hash:{},data:data}):helper)||0===stack1)&&(buffer+=stack1),buffer+="\n</div>"})}),define("taoQtiItem/qtiCommonRenderer/renderers/Include",["tpl!taoQtiItem/qtiCommonRenderer/tpl/include"],function(tpl){"use strict";return{qtiClass:"include",template:tpl}}),define("tpl!taoQtiItem/qtiCommonRenderer/tpl/interactions/associateInteraction",["handlebars"],function(hb){return hb.template(
function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,blockHelperMissing=helpers.blockHelperMissing;function program9(depth0,data){var stack1;return(stack1=typeof depth0===functionType?depth0.apply(depth0):depth0)||0===stack1?stack1:""}return buffer+="<div\n    ",((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.id,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,buffer=""
;return buffer+='id="'+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.id)===functionType?stack1.apply(depth0):stack1)+'"'},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n    class="qti-interaction qti-blockInteraction qti-associateInteraction',((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.class,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,buffer="";return buffer+=" "+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.class)===functionType?stack1.apply(depth0
):stack1)},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='"\n    data-serial="',stack1=(helper=helpers.serial)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.serial)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"\n    data-qti-class="associateInteraction"\n    ',((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1["xml:lang"],{hash:{},inverse:this.noop,fn:this.program(5,function(depth0,data){var stack1,buffer="";return buffer+=' lang="'+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.attributes
...
)+"_"+escapeExpression(typeof depth0===functionType?depth0.apply(depth0):depth0)+'" ',((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.patternMask,{hash:{},inverse:self.noop,fn:self.program(16,program16,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="></textarea>\n            "}function program16(depth0,data){var stack1,buffer="";return buffer+='pattern="'+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.attributes)||!1===stack1?stack1:stack1.patternMask)===functionType?stack1.apply(depth0):stack1)+'"'}function program18(depth0,data){var stack1,helper,options,buffer=""
