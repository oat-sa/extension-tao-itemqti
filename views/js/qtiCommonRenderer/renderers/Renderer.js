 ...
 * 
 * @todo remove css!tao_css/tao-main-style in next major release (it has been moved to qtiLoader.js for better rendering result). It is kept here for previous version compatibility
 */
define([
