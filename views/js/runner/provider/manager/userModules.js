...
define([
    ...
    return {
        ...
        /**
         * allow override of modules for testing purposes
         * this shouldn't be used outside of testing
         * @param newUserModules todo: complete
         */
        setConfig: function setConfig(testConfig) {
            config = testConfig;
        }
    };
});
