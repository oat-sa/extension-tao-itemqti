...
define([
    ...
    /**
     * The display of the ok
     */
    var buttonData = {
        ok : {
            control : 'ok',
            title   : __('Accept and go to the next item'),
            icon    : 'external',
            text    : __('OK')
        },
        end : {
            control : 'ok-end',
            title   : __('Accept and go to the end of the test'),
            icon    : 'external',
            text    : __('Accept and end test')
        }
    };
    ...
    var createElement = function createElement(context){
        var dataType = context.isLast ? 'end' : 'ok';
    ...
    return pluginFactory({
        ...
        init : function init(){
            ...
            var toggle = function toggle(){
                console.log('toggle');
                /*
                todo hide all other, show this button
            ...
            // todo not on load it should to be an action or moveitem event
            testRunner
