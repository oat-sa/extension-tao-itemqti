    ...
    public function check()
    {
        ...
        if (@is_file($mathJaxFile)) {
            $report = new common_configuration_Report(
                ...
                'MathJax JavaScript library installed.',
                $this
            );
        } else {
            $report = new common_configuration_Report(
                common_configuration_Report::INVALID,
                'MathJax JavaScript library not installed. To enable MathML expressions in your QTI items, '
                    . 'you need to install the third-party MathJax library.',
                $this
            );
        }
