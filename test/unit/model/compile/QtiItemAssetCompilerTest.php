...
class QtiItemAssetCompilerTest extends TestCase
{
    ...
    public function testExtractAndCopyAssetFiles()
    {
        ...
        $this->assertSame('stimulus-link', $packedAssets['stimulus-href']->getReplacedBy());
        ...
        $this->assertSame('image-link', $packedAssets['image-src']->getReplacedBy());
    }
    ...
    public function testExtractAndCopyAssetFilesWithImageTwice()
    {
        ...
        $this->assertSame('image-link', $packedAssets['image-src-1']->getReplacedBy());
        ...
        $this->assertSame('image-link0', $packedAssets['image-src-2']->getReplacedBy());
    }
