 ...
 */
class CustomInteractionAssetExtractorAllocatorTest extends TestCase
{
    /**
     * @var CustomInteractionAssetExtractorAllocator
     */
    private $subject;
    ...
    public function testSuccessTextReaderExtractorAllocation(): void
    {
        $extractor = $this->subject->allocateExtractor(
            TextReaderAssetExtractor::INTERACTION_IDENTIFIER
        );
