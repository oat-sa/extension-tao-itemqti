<div class="panel scrollingSelect dw-depended dw-height">
    ...
    <span id="tooltip-scrolling-height" class="tooltip-content">{{__ "Select height of block based on container height"}}</span>
...
<div class="panel scrollingSelect dw-depended dw-width">
    ...
    <span id="tooltip-scrolling-width" class="tooltip-content">{{__ "Select width of block based on container width"}}</span>
